...
export const DEFAULT_CAPABILITIES = {
  ...
  // enum: openai|reasoning-effort|claude-adaptive|claude-budget|gemini-level|gemini-budget|zai|qwen|deepseek|kimi|minimax|hunyuan|step
  thinkingFormat: null,
...
export const MODEL_CAPABILITIES = {
  ...
  // OpenCode Go's GLM-5.3 uses chat-completions reasoning_effort: low/high/max.
  // Thinking cannot be disabled; context/output limits come from Z.ai's API docs.
  "glm-5.3":           { reasoning: true, thinkingFormat: "reasoning-effort", thinkingCanDisable: false, contextWindow: 1048576, maxOutput: 128000 },
  ...
  "kimi-k3":           { vision: true, videoInput: true, reasoning: true, thinkingFormat: "reasoning-effort", thinkingCanDisable: false, contextWindow: 1048576, maxOutput: 131072 },
  "k3":                { vision: true, videoInput: true, reasoning: true, thinkingFormat: "reasoning-effort", thinkingCanDisable: false, contextWindow: 1048576, maxOutput: 131072 },
